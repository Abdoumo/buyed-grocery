  ...
  return (
    <Container>
      <ScrollView style={PrivacyPolicyStyle.paddingHorizontalCommon}>
        <Spacing space={SH(20)} />
        <Text style={[PrivacyPolicyStyle.commonScreenHeadingText]}>Terms and condition for use of {String.appname}</Text>
        <Spacing space={SH(15)} />
        ...
        <Spacing space={SH(20)} />
        <Text style={[PrivacyPolicyStyle.commonScreenText]}>Use of {String.appname}</Text>
        <Spacing space={SH(10)} />
        <Text style={[PrivacyPolicyStyle.commonScreenTextSmall]}>
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
        </Text>
        <Spacing space={SH(20)} />
        <Text style={[PrivacyPolicyStyle.commonScreenText]}>Eligibility</Text>
        <Spacing space={SH(10)} />
        <Text style={[PrivacyPolicyStyle.commonScreenTextSmall]}>
          Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
        </Text>
